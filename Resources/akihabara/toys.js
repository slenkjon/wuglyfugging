...
/*
		    alert( "colh="+th.colh + ",colw="+th.colw +
			   ",colx="+th.colx + ",coly="+th.coly +
			   ",tileset="+th.tileset );
			   */
    ...
    * This initializes some basic basic variables for the object and sets the Z index.
		...
		* </ul>
		*/
	    didCollideWithTile:function(th) { return th.touchedup||th.toucheddown||th.touchedleft||th.touchedright; },
		...
		*/
	    ...
	    // see http://bostongamejams.com/akihabara-tutorials/akihabara-tutorial-part-7-game-logic-and-hud/.
	    /** @return obj == null or an actually collided-with object reference. */
	    findCollision: function(obj,group) {
		for (var i in gbox._objects[group]) {
		    var other = gbox._objects[group][i];
		    if ((!other.initialize)&&toys.topview.collides(obj,other)) {
			return other;
		    }
		}
		return null;
